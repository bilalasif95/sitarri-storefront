...
export const ProductDescription: React.FC<IProps> = ({
  ...
  const [activeTab, setActiveTab] = React.useState(storeCategory.edges[0].node.name);
  const [product, setProduct] = React.useState(storeCategory.edges[0].node.products);
